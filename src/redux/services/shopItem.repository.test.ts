...
describe("Given ProductsApi Service", () => {
    describe("When we instantiate it", () => {
        ...
        // });
        test("Then if I use service.deleteProducts() it should return a Promise of an Array of Foods", async () => {
            global.fetch = jest.fn().mockResolvedValue({
                ok: true,
                json: jest.fn().mockResolvedValue(mockItem),
            });
        ...
        // test("Then if I use service.deleteProducts()  , it should return an error", async () => {
        //     global.fetch = jest.fn().mockResolvedValue({
        //         ok: false,
        //         status: 404,
        //         statusText: "error",
        ...
        //     const expectedResult = await service.deleteProducts(
        //         newmockItem.id
        //     );
        //     const result = new Error("Error 404: error");
        //     result.name = "HTTPError";
        //     expect(expectedResult).toBe(result.toString());
        // });
        // test("Then if I use service.updateProducts() it should return a Promise of an Array of Foods", async () => {
        //     const mockFood = {
        //         name: "good food",
        //         image: "2500",
        //         price: "food url",
        ...
        //     });
        //     const result = await service.updateProducts(40, {
        //         name: "good food",
        //         image: "2500",
        //         price: "food url",
        //     });
        ...
        // });
        // test(`Then if I use service.updateProducts()
        //     , it should return an error`, async () => {
        //     global.fetch = jest.fn().mockResolvedValue({
        //         ok: false,
        //         status: 404,
        ...
        //     const expectedResult = await service.updateProducts(40, {
        //         name: "good food",
        //         image: "2500",
        //         price: "food url",
        //     });
